...
export class HttpService {
  ...
  getColumnsMasterRules(payload): Observable<any> {
    return this.http.post<any>(`${this.rootUrl}/api/rules_mdm`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getColumnsGoldenRules(payload): Observable<any> {
    return this.http.post<any>(`${this.rootUrl}/api/rules_mdm_global`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  createEditMasterRuleset(payload, method) {
    return this.http[method]<any>(`${this.rootUrl}/api/CreateRuleSet_mdm`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  createEditGoldenRuleset(payload, method) {
    return this.http[method]<any>(`${this.rootUrl}/api/CreateRuleSet_Globalmdm`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getGoldenRuleset(payload) {
    return this.http.post<any>(`${this.rootUrl}/api/GetAllMDMdBGLobalRuleList`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getMasterDMview(payload: any) {
    return this.http.post<any>(`${this.rootUrl}/getMasterDMview`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  saveMasterSource(payload, method): Observable<any> {
    return this.http[method]<any>(`${this.rootUrl}/api/configureSource_MDM`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getProfileSource(userDetail: any) {
    return this.http.post<any>(`${this.rootUrl}/api/GetAllProfiledBSourceList`, userDetail).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getCleanSource(userDetail: any) {
    return this.http.post<any>(`${this.rootUrl}/api/GetAllCleandBSourceList`, userDetail).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getSourcesDetails(userDetail: any): Observable<any> {
    return this.http.post<any>(`${this.rootUrl}/api/getAllDetails`, userDetail).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getMasterDataList(userDetail: any): Observable<any> {
    return this.http.post<any>(`${this.rootUrl}/api/GetAllMDMdBSourceList_v1`, userDetail).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getModelimportances(payload): Observable<any> {
    return this.http.post<any>(`${this.rootUrl}/api/getModelimportances`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getVendorDatatypeList(): Observable<any> {
    return this.http.get<any>(`${this.rootUrl}/api/getvendor`).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  createEditVendor(payload, mode): Observable<any> {
    return this.http[mode === 'create' ? 'post' : 'put'](`${this.rootUrl}/api/createvendor`, payload).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
  ...
  getNotificationList(userId): Observable<any> {
    return this.http.post<any>(`${this.rootUrl}/api/getNotificationList`, userId).pipe(
      tap((res) => {
      }),
      catchError(err => {
        return throwError(err);
